...
class App extends Component {
  ...
  onDeleteTrack = uniqueId => {
    const {trackList} = this.state
    const updatedList = trackList.filter(eachItem => eachItem.id !== uniqueId)
  ...
  render() {
    ...
    const noTracksFound = filteredList.length === 0

    return (
      <div className="main-bg">
        <div className="top-half-container">
          <h1 className="name-heading">Ed Sheeran</h1>
          <p className="job-para">Singer</p>
        </div>
        <div className="bottom-half-container">
          <div className="bottom-headers">
            <h2 className="bottom-heading">Songs Playlist</h2>
